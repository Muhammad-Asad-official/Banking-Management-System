...
public class Main extends javax.swing.JFrame {
    ...
    private static boolean getUserData(String account_no, String search_name) {
        try {
            ResultSet rs;
            ...
            if (rs.next()) {
                ...
                if (rs.getString("name").equalsIgnoreCase(search_name)) {
    ...
    public void deposit(String ammount) {
        ...
        try {
            ...
            Icon icon = new javax.swing.ImageIcon(getClass().getResource("/asset/icons/double tick.png"));
            JOptionPane.showMessageDialog(rootPane, "Ammount deposited\nsuccessfully", "Deposit Ammount", JOptionPane.OK_OPTION, icon);
    ...
    public void withdraw(String ammount) {
        ...
        try {
            ...
            Icon icon = new javax.swing.ImageIcon(getClass().getResource("/asset/icons/double tick.png"));
            JOptionPane.showMessageDialog(rootPane, "Ammount Withdrawn\nsuccessfully", "Ammount Withdraw", JOptionPane.OK_OPTION, icon);
    ...
    public final void calender() {
        ...
        dateTextField1.setText(+day + "-" + month + "-" + year);
    ...
    private void initComponents() {
        ...
        developerPanel8 = new javax.swing.JPanel();
        ...
        jPanel10.setBackground(new java.awt.Color(44, 71, 158));
        ...
        searchButton1.setBackground(new java.awt.Color(0, 204, 0));
        searchButton1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        searchButton1.setForeground(new java.awt.Color(0, 204, 0));
        searchButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/icons/icons8-search-client-24.png"))); // NOI18N
        ...
        MainDesign.add(searchButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 20, -1, 30));

        searchTextField2.setBackground(new java.awt.Color(241, 241, 250));
        searchTextField2.setForeground(new java.awt.Color(204, 204, 204));
        searchTextField2.setText("username");
        searchTextField2.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        searchTextField2.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                searchTextField2FocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                searchTextField2FocusLost(evt);
            }
        });
        ...
        MainDesign.add(searchTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, 270, 30));
        ...
        nameText1.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        accNoText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        phNoText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        accTypeText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        genderText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        genderText.setText("Gender:");
        profilePanel1.add(genderText, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, -1, 27));

        addresstext1.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        profilePanel1.add(edditButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 360, 80, 30));

        saveButton2.setBackground(new java.awt.Color(0, 204, 0));
        ...
        profilePanel1.add(saveButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 360, 80, 30));
        ...
        genderText1.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        nationalityText2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        dateOfBirthText3.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        availableBalanceText3.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        depositAmmountText4.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        totalAmmountText5.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        depositButton2.setBackground(new java.awt.Color(0, 204, 0));
        depositButton2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        depositPanel2.add(depositButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 360, 80, 30));
        ...
        availableBalanceText4.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        depositAmmountText5.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        remainningBalanceText6.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        withdrawButton3.setBackground(new java.awt.Color(0, 204, 0));
        withdrawButton3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        withdrawPanel3.add(withdrawButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 360, 90, 30));
        ...
        nextButton4.setBackground(new java.awt.Color(0, 204, 0));
        nextButton4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        senderPanel2.add(nextButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 360, 90, 30));

        recieverPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        transferAmmountText6.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        recieverAccNoText4.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        recieverText5.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        transferButton6.setBackground(new java.awt.Color(0, 204, 0));
        transferButton6.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        recieverPanel1.add(transferButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, 90, 30));

        cancelButton3.setBackground(new java.awt.Color(255, 0, 51));
        cancelButton3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        recieverPanel1.add(cancelButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 360, 90, 30));
        ...
        transferPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(transferPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(senderPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 810, Short.MAX_VALUE))
        );
        transferPanel4Layout.setVerticalGroup(
            transferPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(recieverPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(transferPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(senderPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 419, Short.MAX_VALUE))
        );
        ...
        nameText6.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        accNoText5.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        availableBalanceText6.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        if (transactionTable2.getColumnModel().getColumnCount() > 0) {
            transactionTable2.getColumnModel().getColumn(1).setPreferredWidth(30);
        ...
        developerPanel8.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        developerPanel8.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Simplified Arabic Fixed", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(44, 71, 158));
        jLabel2.setText("Java Developer");
        developerPanel8.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 318, -1));

        jLabel4.setFont(new java.awt.Font("Stencil", 1, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(44, 71, 158));
        jLabel4.setText("Muhammad Asad");
        developerPanel8.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 150, -1, -1));

        jTabbedPane1.addTab("Developer", developerPanel8);

        MainDesign.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 810, 450));

        nameText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        nameText.setText("Date:");
        MainDesign.add(nameText, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 30, -1, 20));

        dateTextField1.setBackground(new java.awt.Color(241, 241, 250));
        dateTextField1.setText("00-00-0000");
        dateTextField1.setEnabled(false);
        MainDesign.add(dateTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 20, 110, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/images/bank.png"))); // NOI18N
        MainDesign.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, 60, 60));
        ...
        MainDesign.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 20, -1, 40));
    ...
    private void searchTextField2FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchTextField2FocusLost
        if (searchTextField2.getText().equals("")) {
            searchTextField2.setText("username");
            searchTextField2.setForeground(new Color(204, 204, 204));
        }
    }//GEN-LAST:event_searchTextField2FocusLost

    private void searchTextField2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchTextField2FocusGained
        if (searchTextField2.getText().equals("username")) {
            searchTextField2.setText("");
            searchTextField2.setForeground(Color.black);
        }
    }//GEN-LAST:event_searchTextField2FocusGained

    private void searchButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton1ActionPerformed
        String searchName = "";
        if (!"username".equals(searchTextField2.getText())) {
            searchName = searchTextField2.getText();
        }
        Boolean checker = true;
        if (!"".equals(searchName)) {
            if (Main.getUserData(accNO, searchName)) {
                ...
                Icon icon = new javax.swing.ImageIcon(getClass().getResource("/asset/icons/person.png"));
                JOptionPane.showMessageDialog(rootPane, "UserName Matched\nsuccessfully", "Authenticate UserName", JOptionPane.OK_OPTION, icon);
            }
            if (checker) {
                JOptionPane.showMessageDialog(rootPane, "Invalid UserName!", "Authenticate UserName", JOptionPane.YES_OPTION);
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Please enter UserName!", "Authenticate UserName", JOptionPane.YES_OPTION);
        }
...
//                }
    ...
    private javax.swing.JPanel developerPanel8;
