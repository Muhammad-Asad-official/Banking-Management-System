...
public class CreatAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Background.setBackground(new java.awt.Color(44, 71, 158));
        ...
        bankingManagementText.setFont(new java.awt.Font("Simplified Arabic Fixed", 1, 24)); // NOI18N
        bankingManagementText.setForeground(new java.awt.Color(44, 71, 158));
        bankingManagementText.setText("Banking Management System");
        MainDesign.add(bankingManagementText, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, -1, -1));

        bankIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/images/bank_78392.png"))); // NOI18N
        MainDesign.add(bankIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 140, 140));

        passwordTextField1.setEditable(false);
        passwordTextField1.setBackground(new java.awt.Color(241, 241, 250));
        MainDesign.add(passwordTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, 190, -1));
        ...
        MainDesign.add(ammountTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 420, 190, -1));
        ...
        MainDesign.add(nameTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 100, 190, -1));
        ...
        MainDesign.add(accNoTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 180, 190, -1));
        ...
        MainDesign.add(phNoTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 340, 190, -1));

        nameText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        nameText.setText("Name: ");
        MainDesign.add(nameText, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, -1, 27));

        accTypeText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        accTypeText.setText("Account Type:");
        MainDesign.add(accTypeText, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, -1, 27));

        accNoText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        accNoText.setText("Accout  NO:");
        MainDesign.add(accNoText, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, -1, 27));

        phNoText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        phNoText.setText("Phone No:");
        MainDesign.add(phNoText, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, -1, 27));

        passwordText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        passwordText.setText("Password:");
        MainDesign.add(passwordText, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, -1, 27));

        ammoounttext.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ammoounttext.setText("Ammount:");
        MainDesign.add(ammoounttext, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 420, -1, 30));

        genderText.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        genderText.setText("Gender:");
        MainDesign.add(genderText, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 260, -1, 27));
        ...
        MainDesign.add(femaleRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 260, -1, -1));
        ...
        MainDesign.add(maleRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 260, -1, -1));
        ...
        MainDesign.add(accTypeComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 180, 190, -1));

        creatButton1.setBackground(new java.awt.Color(0, 204, 0));
        creatButton1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        MainDesign.add(creatButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 500, 60, -1));
        ...
        MainDesign.add(backButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 500, 60, -1));
        backButton2.getAccessibleContext().setAccessibleName("btn_Back");

        clearButton3.setBackground(new java.awt.Color(255, 0, 51));
        clearButton3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        MainDesign.add(clearButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 500, 60, -1));
        clearButton3.getAccessibleContext().setAccessibleName("btn_Clear");

        addresstext1.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        addresstext1.setText("Address:");
        MainDesign.add(addresstext1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 340, -1, 27));
        ...
        MainDesign.add(addressTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 340, 190, -1));
        ...
        MainDesign.add(nationalityTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 420, 190, -1));

        phNoText1.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        phNoText1.setText("Nationality:");
        MainDesign.add(phNoText1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 420, -1, 27));

        dobText2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        dobText2.setText("Date Of Birth");
        MainDesign.add(dobText2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, -1, 27));

        dateOfBirthChooser1.setBackground(new java.awt.Color(241, 241, 250));
        dateOfBirthChooser1.setName("dateOfBirthChooser1"); // NOI18N
        MainDesign.add(dateOfBirthChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 100, 190, -1));

        Background.add(MainDesign, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 910, 560));
